...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    //DESPUES DE HACER UN ECHO     JSON ENCODE, YA NO DEBERÍA HABER MÁS CÓDIGO
        ...
        try {           
           ...
           $consulta = $conexion->prepare("SELECT firmaimgresultado,mimefirmaimgresultado FROM `peticion` WHERE idpeticion=:idpeticion");        
           ...
           header('Content-Type: ' . $fila['mimefirmaimgresultado']);
           
           echo ($fila['firmaimgresultado']);    
